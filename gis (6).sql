...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Jul 2022 pada 09.00
...
INSERT INTO `histories` (`id`, `customer_id`, `tanggal`, `trouble`, `action`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
(6, 52, '2021-10-16', 'Kabel putus Di rumah', 'resplice di odp', '', '2021-10-15 23:57:51', '2021-10-16 07:11:38', '2021-10-16 07:11:38'),
(7, 56, '2021-10-15', 'kabel putus di atas genting rumah pelanggan', 'Resplice kabel fiber iptik', 'Selesai', '2021-10-21 20:15:28', '2022-02-24 00:22:31', NULL),
(8, 86, '2021-10-22', 'modem hang', 'ganti modem baru', 'On Progress', '2021-10-22 03:40:33', '2022-02-24 00:22:36', NULL),
(9, 80, '2021-10-22', 'kabel fo putus di fast konektor', 'ganti konektor baru', 'On Progress', '2021-10-22 03:41:14', '2022-02-23 23:00:01', NULL),
(10, 74, '2021-10-22', 'Fo cut di dalam ODP', 'rescplice kabel FO', 'On Progress', '2021-10-22 03:41:51', '2022-02-23 23:00:07', NULL),
(11, 70, '2021-10-25', 'Kabel Fiber optik putus di dalam rumah', 'resplice kabel fiber optik', 'Selesai', '2021-10-24 21:18:01', '2022-02-23 23:59:59', NULL),
(12, 101, '2021-10-26', 'kabel fo putus didalam odp', 'resplice didalam odp', '', '2021-10-25 21:30:00', '2022-02-24 02:51:08', '2022-02-24 02:51:08'),
(13, 96, '2021-10-27', 'adaptor modem rusak', 'ganti adaptor baru', 'Selesai', '2021-10-26 23:13:36', '2022-02-24 03:07:29', NULL),
...
CREATE TABLE `regions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kode_wilayah` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
(6, 'Admin', 'admin@powertel.com', NULL, '$2y$10$SSQPGJ9AAACRywWYLmm2XexFNlzbO58C1lVz//pJG//hSEsjlSAAC', 'KRYHk7vJ4cQG0lp9SYI9d2RIm6L1HqqNec86FWf4VtOpjS4ydXfH3yT9VLFr', '2021-08-18 06:24:48', '2021-10-24 04:20:45'),
(7, 'Teknisi', 'teknisi@powertel.com', NULL, '$2y$10$XYnhVYHsFkKpVnNeIP26r.PksoVNJrrzHHh5IEEdc/.62SRWWFLYi', 'gjDO1BwB2iEoCVNJwzasGUst3H0BcqgSlbFISlggwlTEKeHIAPr6nW5cM6un', '2021-08-18 06:24:49', '2021-10-24 04:20:36');
