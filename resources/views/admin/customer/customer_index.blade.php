        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                    <a href="{{ url('/admin/customer/store') }}" class="btn btn-success btn-tambah"><i
                            ...
                            @foreach ($customer as $index => $customer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('admin/customer/' . $customer->id) }}" class="btn btn-warning"><i
                                                class="fa fa-pencil"></i></a>
                                        <a href="{{ url('admin/customer/detail/' . $customer->id) }}"
                                            class="btn btn-info"><i class="fa fa-eye"></i></a>
                                        <a href="{{ url('admin/customer/delete/' . $customer->id) }}"
...
<script>
 var mymap = L.map('mapid').setView([-7.563828, 110.8173266], 12);
